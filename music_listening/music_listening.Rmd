...
df_playlist <- read_sheet("https://docs.google.com/spreadsheets/d/1ikmr00SgTuC-iGjVNZMD8ClCgATz98KCAQvR2U5baIw/edit#gid=1036964301")
...
df_play_summary <- df_play_summary %>%
  mutate(roll_avg = roll_mean(x = n, n = 7, fill = NA))

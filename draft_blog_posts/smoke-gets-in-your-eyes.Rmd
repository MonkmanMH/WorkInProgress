...
It was recently announced that during 2018, [British Columbia has seen the most extensive forest fire season on record](https://www.cbc.ca/news/canada/british-columbia/state-emergency-bc-wildfires-1.4803546)

As I write this (2018-08-31) there are [currently 442 wildfires burning in British Columbia](http://bcfireinfo.for.gov.bc.ca/hprScripts/WildfireNews/Fires.asp?Mode=normal&AllFires=0&FC=0). These fires have a significant impact on people's lives--many areas are under evacuation order and evacuation alert, and there are reports that homes have been destroyed by the blazes.
...
The majority of British Columbians live in the Metro Vancouver area; I've selected the Burnaby South station as one to represent the entire region, since it's somewhere in the middle of where the region's residents live.

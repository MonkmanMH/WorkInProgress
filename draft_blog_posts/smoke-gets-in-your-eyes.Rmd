...
### all three stations in one plot

You may have noticed that the Y axis on the three plots is quite different--Victoria reaches 300, Smithers gets to 400, and Prince George is double that at 800. There are two ways we can compare the three stations: a single plot, or faceted plots.
...
station_name <- c("Prince George Plaza 400", "Smithers St Josephs", "Victoria Topaz")
...
PM25_data %>%
  ...
  labs(x = "date",
       title = glue("Air quality: Prince George, Smithers, Victoria"),
       subtitle = "one hour average, µg/m3 of PM2.5", 
       caption = "data: Ministry of Environment and Climate Change Strategy")

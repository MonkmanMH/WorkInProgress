...
Of course, regression to the mean is a thing, and later in the season their luck ran out. 

I've written before about run scoring and prevention (here and here); this time, I will compare the individual team performance in a single season.  This will look at the simplest of the measures of "win expectation" that have burbled up in the Sabremetric community over the years; the other approaches may be worthy of consideration for a future post.
...
We'll rely on the [`Lahman` package](https://cran.r-project.org/web/packages/Lahman/), which will (at this writing) take us through the 2016 season.
